...
func SetupAuthServer(db *db.Config, authCfg *oauth2.Config) (server *authx.Server, err error) {
...
func Initializer(instance *db.Config, authCfg *oauth2.Config) micro.Option {
